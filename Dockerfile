...
FROM --platform=$BUILDPLATFORM node:12-alpine3.11 AS app-builder
...
FROM --platform=$BUILDPLATFORM python:3.8-alpine3.11 as docs-builder
...
FROM --platform=$TARGETPLATFORM python:3.8-alpine3.11
